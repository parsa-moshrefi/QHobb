...
const float winScore = 100.0f;
const unsigned int winningScore = 100;
const UINT swapFlag = 
	WGL_SWAP_MAIN_PLANE | WGL_SWAP_OVERLAY1 | WGL_SWAP_OVERLAY2 |
	WGL_SWAP_OVERLAY3 | WGL_SWAP_OVERLAY4 | WGL_SWAP_OVERLAY5 |
	WGL_SWAP_OVERLAY6 | WGL_SWAP_OVERLAY7 | WGL_SWAP_OVERLAY8 |
	WGL_SWAP_OVERLAY9 | WGL_SWAP_OVERLAY10 | WGL_SWAP_OVERLAY11 |
	WGL_SWAP_OVERLAY12 | WGL_SWAP_OVERLAY13 | WGL_SWAP_OVERLAY14 |
	WGL_SWAP_OVERLAY15 | WGL_SWAP_UNDERLAY1 | WGL_SWAP_UNDERLAY2 |
	WGL_SWAP_UNDERLAY3 | WGL_SWAP_UNDERLAY4 | WGL_SWAP_UNDERLAY5 |
	WGL_SWAP_UNDERLAY6 | WGL_SWAP_UNDERLAY7 | WGL_SWAP_UNDERLAY8 |
	WGL_SWAP_UNDERLAY9 | WGL_SWAP_UNDERLAY10 | WGL_SWAP_UNDERLAY11 |
